<x-layout>
    ...
    <div class="container text-blu mb-3">
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('become.revisor') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="tel" class="form-control" id="phone" name="phone"
                                            placeholder="{{ __('auth.telephoneNumber') }}"
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <select class="form-select bg-blu text-white" id="position" name="position"
                                            required>
                                            <option value="developer">{{ __('auth.reviewer') }}</option>
                                        </select>
                                        <label for="position"
                                            class="text-white">{{ __('auth.positionInterest') }}</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-2">
                                        ...
                                        <label for="experience"
                                            class="text-blu fs-6">{{ __('auth.tellUs') }}...</label>
                                    </div>
                                </div>
                                <div class="col-12">
        ...
        <hr>
        <div class="row mt-4">
            <h1 class="display-4 my-4 text-center">{{ __('auth.openPositions') }}</h1>
            <div class="col-12">
                <div class="card bg-blu text-white border-0 shadow-sm">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-4">
                            <h3 class="fw-bold">{{ __('auth.reviewer') }}</h3>
