<footer class="border-top border-3 mt-auto pt-5 pb-4 bg-light shadow-sm">
    <div class="container">
        <div class="row mb-4 align-items-center text-center text-md-start">
            ...
            <div class="col-12 col-md-4 mb-4 mb-md-3 d-flex flex-column justify-content-center align-items-center">
                ...
                <h6 class="text-uppercase fs-2  text-blu my-3">Seguici</h6>
            ...
            <div class="col-12 col-md-4 d-flex flex-column align-items-center align-items-md-end">
                <hr class="mb-4">
                <h6 class="text-uppercase display-6 text-blu mb-1">Contattaci</h6>
                ...
                <p class="mb-0 text-muted ">
                    <i class="bi bi-geo-alt me-2"></i> Nomadi digitali
                </p>
            </div>
        </div>
        <hr class="mb-4">
