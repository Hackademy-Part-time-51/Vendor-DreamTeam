            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-evenly w-100 align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a class="dropdown-item" href="{{route('messaggi')}}"><i class="bi bi-chat"></i> {{__('user.message')}} <span class="@if (Auth::user()->messages->count() > 0)
                ...
                <li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item " href="{{route('terms')}}">{{__('navbar.termsAndConditions')}}</a></li>
                    </ul>
                </li>
                {{-- contatti --}}
                <li class="nav-item dropdown">
