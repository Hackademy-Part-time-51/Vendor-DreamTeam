          ...
          <div class="container-fluid ">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-evenly w-100 align-items-center">
                  ...
                  <li class="nav-item dropdown">
                      <a class="nav-link text-white scalebig  fs-mininav" href="#" role="button"
                      ...
                      <ul class="dropdown-menu">
                          @foreach (Category::all() as $category)
                              <li><a class="dropdown-item"
                                      href="{{ route('products.index', ['category' => $category->id]) }}">{{ __('category.' . $category->name) }}</a>
                              </li>
                          @endforeach
                  ...
                  {{-- area personale --}}
                  <li class="nav-item dropdown">
                      <a class="nav-link scalebig text-white fs-mininav" href="#" role="button"
                          data-bs-toggle="dropdown" aria-expanded="false">
                          <i class="bi bi-person-circle me-2"></i> {{ __('navbar.personalArea') }} <br>
                      </a>
                      ...
                      @guest
                          <ul class="dropdown-menu">
                              ...
                              <li>
                                  <a class="dropdown-item " href="{{ route('register') }}"><i class="bi bi-person-plus"></i>
                                      {{ __('auth.register') }}
                                  </a>
                              </li>
                          </ul>
                      ...
                      @auth
                          <ul class="dropdown-menu">
                              <li>
                                  <a class="dropdown-item text-blu" href="{{ route('personalArea', Auth::user()->id) }}"><i
                                          class="bi bi-person-lines-fill"></i> {{ __('navbar.profile') }}</a>
                              </li>
                              <li>
                              ...
                              <a class="dropdown-item text-blu" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                                  href="#"><i class="bi bi-box-arrow-left"></i> {{ __('navbar.logout') }}</a>
                      </li>
                  </ul>
              @endauth
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item "
                              href="{{ route('terms') }}">{{ __('navbar.termsAndConditions') }}</a></li>
                  </ul>
              </li>
              {{-- contatti --}}
              <li class="nav-item dropdown">
          ...
          <div class="modal-content">
              ...
              <div class="modal-footer justify-content-start">
                  ...
                  <form action="{{ route('logout') }}" method="POST">
                      @csrf
                      <button class="btn btn-rosso text-white"
                          data-bs-dismiss="modal">{{ __('navbar.confirmLogout') }}</button>
                  </form>
              </div>
          </div>
      </div>
