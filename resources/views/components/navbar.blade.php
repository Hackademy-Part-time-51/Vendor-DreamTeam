      ...
      <div class="modal-content">
        ...
        <div class="modal-body py-4">
          <div class="list-group list-group-flush">
            ...
            <a href="{{ route('products.index') }}" class="list-group-item list-group-item-action text-blu d-flex align-items-center py-4 fs-3">
              <i class="bi bi-list-task fs-2 me-3"></i>{{ __('navbar.allProducts') }}
            </a>
            <a href="{{ route('products.create') }}" class="list-group-item list-group-item-action text-blu d-flex align-items-center py-4 fs-3">
      ...
      <div class="offcanvas-body d-flex flex-column justify-content-between p-0">
        <div class="list-group list-group-flush" id="userMenu">
          <a href="{{ route('personalArea', Auth::user()->id) }}"
             class="list-group-item list-group-item-action text-blu d-flex align-items-center py-4 fs-2">
          ...
          <button type="button"
                  class="list-group-item list-group-item-action text-danger d-flex align-items-center py-4 fs-2 border-0"
