<div  id="notification"
    x-data="{ show: false }"
    x-show="show"
    x-init="$wire.on('showNotification', () => { show =true; setTimeout(() => show = false, 3000); });
            $wire.on('hideNotification', () => { show = false; });"

    class="alert alert-success mx-auto alert-dismissible fade show text-center w-25 sticky-top mt-5"
    >
